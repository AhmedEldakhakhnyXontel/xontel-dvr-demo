...
public class Constants {
    ...
    /**
     * the appid is set in the custom_flag
     */

    /**
     * Client ID is generated by the server. If you need push function, you need to bind the PUSH_APPID, PUSH_APPKEY, and PUSH_APPSECRET pushed by third parties in the background.
     */
    ...
    public static String DAX_USER= "admin";// 设备密码
    //zd1234

    public static String DAX_PASSWORD= "admin";// 设备密码
    //zd1234
