package com.example.xonteldvrdemo.umeyesdk.utils;
...
public class Utility {
	...
	private static class OnDialogBack implements
			DialogInterface.OnClickListener// 确认对话框的确定按钮事件
	{
	...
	public static String GetIMSI(Context c) {
		...
		@SuppressLint("MissingPermission") String subscriberId = mTelephonyMgr.getSubscriberId();
		@SuppressLint("MissingPermission") String deviceId = mTelephonyMgr.getDeviceId();
